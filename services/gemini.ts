...
// Fix: Strictly follow the guideline for using process.env.API_KEY and direct initialization.
export const generatePostTitle = async (body: string): Promise<string> => {
  ...
  try {
    ...
    // Fix: Use .text property directly as per guidelines.
...
export const generateVisionImage = async (prompt: string): Promise<string | null> => {
    ...
    try {
        ...
        // Fix: Use strict generateContent for image generation as per guidelines.
