...
export const SectionHeader = ({ icon, title, subtitle, action }: {
    ...
    <div className="mb-8 flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-emerald-100 bg-gradient-to-r from-emerald-50 to-white px-6 py-5 shadow-xl">
