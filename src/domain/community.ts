...
export interface Community extends Being {
  ...
  // whether the place is scoped or reflecting (ring 2026-09-07: strict wins; the viewer's own
  // live in their profile). Absent = the owner-merge stays (today's behaviour).
  strictScope?: boolean;
}
