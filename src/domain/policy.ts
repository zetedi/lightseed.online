...
// Thin today (caring a tree's circle and joining a vision are self-service for any signed-in
...
export const canCareForTree = (viewerUid?: string | null): viewerUid is string => !!viewerUid;
