...
const baseKeys = {
  ...
  signing_start_fresh: "Start fresh (a new key)",
  signing_start_fresh_warn: "Starting fresh mints a NEW key and moves your identity to it. What you signed before stays verifiable through your key history, but the old phrase no longer matches your current key — anything still unsigned must be signed with the new one. Only do this if the recovery phrase is truly lost.",
  signing_start_fresh_confirm: "I understand my identity moves to a new key and the old phrase stops matching it.",
  ...
  signing_stale_warn: "A NEWER signing key is published for this account — this device still holds an older one. Restore your current recovery phrase here to sign with your present identity. Republishing this device's old key instead would move your identity BACK to it.",
  signing_stale_confirm: "I understand this moves my identity back to this device's older key.",
  signing_stale_takeover: "Republish this device's key anyway",
  signing_restore_mismatch_warn: "This phrase is valid, but it restores a DIFFERENT key than the one published for this account. If you expected your current key, check the phrase. Replacing moves your identity to this phrase's key; what you signed before stays verifiable through your key history.",
  signing_restore_replace_confirm: "I understand my identity moves to this phrase's key.",
  signing_restore_replace: "Replace the published key",
