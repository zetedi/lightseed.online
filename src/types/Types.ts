...
// Legacy Simulator Type (Kept for compatibility if needed)
export type Tree = {
  id: string;
  name: string;
  kind: "mother" | "lifetree" | "guardian";
  lat: number;
  lng: number;
  note?: string;
  color: string;
