      ...
      <div className="space-y-4">
        <div>
          ...
          <input value={name} onChange={e => setName(e.target.value)} autoFocus
            ...
            className="w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 dark:border-slate-700 dark:text-slate-50" />
        </div>
        <div>
          ...
          <textarea value={body} onChange={e => setBody(e.target.value)} rows={3}
            ...
            className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 dark:border-slate-700 dark:text-slate-50" />
        </div>
        <div>
