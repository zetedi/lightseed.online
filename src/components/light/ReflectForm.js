...
import { submitReflect } from "../../redux/actions/dataActions";
...
class ReflectForm extends Component {
  ...
  handleSubmit = (event) => {
    ...
    this.props.submitReflect(this.props.lightId, { body: this.state.body });
  };
...
ReflectForm.propTypes = {
  submitReflect: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { submitReflect })(
