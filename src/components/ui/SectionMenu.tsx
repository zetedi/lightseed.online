...
export const SectionMenu = ({ items, active, onSelect, className = '', orientation = 'responsive' }: {
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <button type="button" onClick={() => nudge(-180)} aria-label="Scroll menu left" className={`${arrowCls} -left-2.5`}>
      ...
      <button type="button" onClick={() => nudge(180)} aria-label="Scroll menu right" className={`${arrowCls} -right-2.5`}>
