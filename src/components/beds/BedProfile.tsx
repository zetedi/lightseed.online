      ...
      hero={{
        ...
        avatar: (
          <div className="relative">
            {heroImg
              ? <><Picture size={480} src={heroImg} alt={bed.name} className="h-16 w-16 rounded-full border-4 border-white bg-white object-cover shadow-xl md:h-24 md:w-24 dark:bg-slate-900" /><FullViewButton src={heroImg} alt={bed.name} className="-bottom-1 -right-1" /></>
